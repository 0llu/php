...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="index.php">Serman.com</a>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="index.php">Avaleht</a></li>
                    <li class="nav-item"><a class="nav-link" href="index.php?leht=pood">Pood</a></li>
                ...
                <div class='col'>
                    <div class='card h-100 shadow-sm'>
                        ...
                        <div class='card-body'>
                            ...
                            <a href='?kustuta={$kustuta}' class='btn btn-danger w-100'>Kustuta</a>
                        </div>
                    </div>
                </div>";
            }
